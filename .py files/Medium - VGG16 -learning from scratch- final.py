...
base_dir = '/Users/nachofango/machine_learning/ML_basil_stress_detection/DATA-PROCESSING/data'
...
model.compile(
    optimizer=tf.keras.optimizers.SGD(learning_rate=0.001, momentum=0.9), # optimization algorithm
